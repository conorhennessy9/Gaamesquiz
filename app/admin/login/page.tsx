    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-[#6b7280] text-sm">Sign in to access the admin area</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          {error && (
            <div
              role="alert"
              className="px-3 py-2.5 bg-red-500/10 border border-red-500/20 rounded-md text-red-400 text-sm"
            >
              {error}
            </div>
          )}
        ...
        <p className="text-center text-[#4b5563] text-xs mt-6">Restricted to authorised administrators only.</p>
      </div>
    </div>
  )
}
