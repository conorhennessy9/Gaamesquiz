      ...
      <header className="p-4 border-b border-green-700/50">
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-white tracking-wider">NAME THE PLAYER</h1>
      ...
      <div className="container mx-auto px-4 py-12">
        <Card className="bg-black/50 border-green-700/50 max-w-3xl mx-auto">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-slate-300 mb-8">Name the Player is coming soon!</p>
            ...
            <div className="bg-slate-800/70 p-6 rounded-lg text-left max-w-lg mx-auto mb-8">
              ...
              <ul className="text-white space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span>Daily player images with blurred faces</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-400">•</span>
                  <span>County and club hints</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-400">•</span>
                  <span>Position and achievement clues</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-400">•</span>
                  <span>Both hurling and football players</span>
                </li>
              </ul>
            </div>
