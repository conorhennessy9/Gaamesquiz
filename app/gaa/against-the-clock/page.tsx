...
import { getGAAClockQuestionByDate } from "./actions"
import { AnswerAutocomplete } from "@/components/answer-autocomplete"

interface GAAClockQuestion {
  id: number
...
const DEFAULT_QUESTION = {
  question_text: "Name the counties that have won the All-Ireland Senior Football Championship",
  answers: ["Kerry", "Dublin", "Galway", "Mayo", "Cork"],
}
...
export default function GAAAgainstTheClock() {
  ...
  useEffect(() => {
    const loadTodaysQuestion = async () => {
      ...
      try {
        ...
        const dbQuestion = await getGAAClockQuestionByDate(today)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-green-800 to-emerald-900 pb-8">
      <header className="p-4">
        <div className="container mx-auto">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-white text-xl font-bold">GAA Against The Clock</h1>
            <div className="flex items-center gap-2">
              ...
              <Link href="/gaa/against-the-clock/admin">
                <Button variant="ghost" size="icon" className="text-white hover:bg-white/10">
      ...
      <main className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
                  ...
                  {!gameStarted && !gameOver ? (
                    <div className="text-center py-8 space-y-6">
                      ...
                      <Button
                        onClick={startGame}
                        size="lg"
                        className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 border-none"
                      >
                        Start Challenge
                      </Button>
                    </div>
          ...
          <div className="mt-6 text-center">
            <Link href="/gaa/against-the-clock/admin">
              <Button variant="outline" className="border-white/20 text-white bg-white/5">
